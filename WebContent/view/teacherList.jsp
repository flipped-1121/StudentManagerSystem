...
<div id="addDialog" style="padding: 10px;">
    ...
    <form id="addForm" method="post">
        <table id="addTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6">
            ...
            <tr>
                <td>工号:</td>
                <td colspan="4"><input id="add_sn" style="width: 200px; height: 30px;" class="easyui-textbox"
                                       type="text" name="sn" validType="number"/></td>
            </tr>
            <tr>
                <td>姓名:</td>
...
<div id="editDialog" style="padding: 10px">
    ...
    <form id="editForm" method="post">
        <table id="editTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6">
            ...
            <tr>
                <td>工号:</td>
                <td colspan="4"><input id="edit_sn" style="width: 200px; height: 30px;" class="easyui-textbox"
                                       type="text" name="sn" validType="number"/></td>
            </tr>
            <tr>
                <td>姓名:</td>
