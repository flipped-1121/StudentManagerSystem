...
<div id="addDialog" style="padding: 10px">
    ...
    <form id="addForm" method="post">
        <table cellpadding="8">
            <tr>
                <td>学号:</td>
                <td><input id="add_sn" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="sn"
                           data-options="required:true, missingMessage:'请填写学号'" validType="number"/></td>
            </tr>
            <tr>
                <td>姓名:</td>
            ...
            <tr>
                <td>所在院系:</td>
                <td><input id="add_dep" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="dep" validType=""/></td>
            </tr>
            <tr>
                <td>班级:</td>
...
<div id="editDialog" style="padding: 10px">
    ...
    <form id="editForm" method="post">
        ...
        <table cellpadding="8">
            <tr>
                <td>学号:</td>
                <td><input id="edit_sn" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="sn"
                           data-options="required:true, missingMessage:'请填写学号'" validType="number"/></td>
            </tr>
            <tr>
                <td>姓名:</td>
            ...
            <tr>
                <td>所在院系:</td>
                <td><input id="edit_dep" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="dep" validType=""/></td>
            </tr>
            <tr>
                <td>班级:</td>
