...
public class TeacherDao extends BaseDao {
	...
	public boolean addTeacher(Teacher teacher){
		...
		sql += ",'" + teacher.getPassword() + "'";
		// sql +=  "'," + teacher.getClazzId();
		sql += ",'" + teacher.getSex() + "','" + teacher.getMobile() + "'";
		sql += ",'" + teacher.getDep() + "',null)";
	...
	public Teacher getTeacher(int id){
		...
		try {
			if(resultSet.next()){
				...
				teacher.setDep(resultSet.getString("dep"));
	...
	public List<Teacher> getTeacherList(Teacher teacher,Page page){
		...
		try {
			while(resultSet.next()){
				...
				t.setDep(resultSet.getString("dep"));
